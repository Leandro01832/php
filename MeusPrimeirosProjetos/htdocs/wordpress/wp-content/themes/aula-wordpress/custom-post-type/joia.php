...
function custom_post_type_joia() {
  ...
  $labels = array(
    ...
    'name_admin_bar'        => __( 'joia', 'text_domain' ),
  ...
  $args = array(
    'label'                 => __( 'joia', 'text_domain' ),
    'description'           => __( 'Descrição da joia', 'text_domain' ),
    'labels'                => $labels,
...
add_action( 'init', 'custom_post_type_joia');