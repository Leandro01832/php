...
function custom_post_type_pregacao() {

  $labels = array(
    'name'                  => _x( 'pregacoes', 'pregações', 'text_domain' ),
    'singular_name'         => _x( 'pregacao', 'pregações', 'text_domain' ),
    'menu_name'             => __( 'pregacoes', 'text_domain' ),
    'name_admin_bar'        => __( 'pregacao', 'text_domain' ),
  ...
  $args = array(
    'label'                 => __( 'pregacao', 'text_domain' ),
    'description'           => __( 'Descrição do pregacao', 'text_domain' ),
    'labels'                => $labels,
  ...
  register_post_type( 'pregacao', $args );

}
add_action( 'init', 'custom_post_type_pregacao', 0);