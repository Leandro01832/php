...
function custom_post_type_ministerio() {
  ...
  $labels = array(
    'name'                  => _x( 'ministerios', 'ministerios', 'text_domain' ),
    'singular_name'         => _x( 'ministerio', 'ministerios', 'text_domain' ),
    'menu_name'             => __( 'ministerios', 'text_domain' ),
    'name_admin_bar'        => __( 'ministerio', 'text_domain' ),
  ...
  $args = array(
    'label'                 => __( 'ministerio', 'text_domain' ),
    'description'           => __( 'Descrição do ministerio', 'text_domain' ),
    'labels'                => $labels,
...
add_action( 'init', 'custom_post_type_ministerio', 0);